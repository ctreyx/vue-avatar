<template>
  ...
  >
    ...
    <!-- <div class="avatar-payload" v-html="a" /> -->
...
const setSvgContent = (content: string) => (svgContent.value = content)
const getSvgContent = () => svgContent.value + ''
...
defineExpose({ avatarRef, setSvgContent, getSvgContent })
</script>
